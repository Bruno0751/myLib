...
<html lang="pt-br">
    ...
    <body>
        ...
        <section>
            ...
            <% if (casa) {%>
            <!--<div class="centro">-->
            <div><button type="button" class="btn btn-outline-primary" onClick="requisitar('prj')">PRJ</button></div>
            <div><button type="button" class="btn btn-outline-secondary" onClick="requisitar('msc')">MSC</button></div>
            <div><button type="button" class="btn btn-outline-primary" onClick="requisitar('minhasMusicas')">Minhas</button></div>
            <!--</div>-->
            <% }%>
            ...
            <a href="https://www.starplus.com/pt-br/home" target="_blank">
                <img src="images/starPlus.png" class="rounded mx-auto d-block"alt="STAR PLUS" title="STAR PLUS" width="10%" height="100px;">
            </a>
            ...
            <ul>
                ...
                <li>
                    <a href="https://www.cinemark.com.br/filme/doutor-estranho-no-multiverso-da-loucura?utm_source=search&utm_medium=ga&utm_campaign=doutor_estranho2&utm_id=vzz_28149https://www.cinemark.com.br/filme/doutor-estranho-no-multiverso-da-loucura?utm_source=search&utm_medium=ga&utm_campaign=doutor_estranho2&utm_id=vzz_281491854759516&utm_term=trf1854759516&utm_term=trf&gclid=Cj0KCQjwsdiTBhD5ARIsAIpW8CJaFe586WI06ws5IP7OW9pz9xWptOr3-JgqfJqYQN2DAsnxRkYtunAaAuNGEALw_wcB" target="_blank">
                        <img src="images/cinemark.png" alt="CINEMARK" title="CINEMARK" class="imgLink">
                    </a>
                </li>
            </ul>
            -->
